                    ...
                    <div className="col-sm-12 nav-bg" style={{ padding: '0%', margin: '0%' }}>
                        ...
                        <div className="col-sm-6" style={{ backgroundColor: '#3c3c54' }}>
                            ...
                            <div className="col-sm-6" style={{ marginTop: '20%' }}>
                                <h3 style={{ fontSize: 16, color: '#fff', marginBottom: 1 }}>Your transaction is successful</h3>
...
const connectedLiveStatus = withRouter(connect(mapStateToProps)(LiveStatus));
export { connectedLiveStatus as LiveStatus }; 
